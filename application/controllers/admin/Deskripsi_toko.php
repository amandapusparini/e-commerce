...
class Deskripsi_toko extends Super //class mengikuti nama file. diawali dengan huruf besar
{
    ...
    function __construct()
    {
        ...
        $this->tabel          = "toko"; //nama tabel sesuai dengan nama yg ada di database
        $this->active_id_menu = "Deskripsi Toko";
        $this->nama_view      = "Deskrpsi Toko"; //tampilan untuk di view
        $this->status         = true; 
        $this->field_tambah   = array(); 
        $this->field_edit     = array(); 
        $this->field_tampil   = array(); 
        $this->folder_upload  = 'assets/uploads/toko';
        $this->add            = false;
        $this->edit           = true;
        $this->delete         = false;
        $this->crud;
