...
class Sub_kategori extends Super //class mengikuti nama file. diawali dengan huruf besar
{
    ...
    function __construct()
    {
        ...
        $this->tabel          = "sub_kategori"; //nama tabel sesuai dengan nama yg ada di database
        $this->active_id_menu = "Sub Kategori";
        $this->nama_view      = "Sub Kategori"; //tampilan untuk di view
        $this->status         = true; 
