		...
		<div class="home">
			...
			<div class="home_slider_container">
				<div class="owl-carousel owl-theme home_slider">
					...
					<!-- Slide -->
					<div class="owl-item">
						<div class="background_image" style="background-image:url(<?php echo base_url('assets/user');?>/images/bc_bfo.png)"></div>
											...
											<div class="home_items">
												<div class="row">
													<div class="col-sm-3 offset-lg-1">
														<div class="home_item_side"><a href="product.html"><img src="<?php echo base_url('assets/user');?>/images/pisang_bakar_keju_meses.jpg" alt=""></a></div>
													</div>
													<div class="col-lg-4 col-md-6 col-sm-8 offset-sm-2 offset-md-0">
														<div class="product home_item_large">
															<div class="product_tag d-flex flex-column align-items-center justify-content-center">
																<div>
																	<div>Mulai Dari</div>
																	<div>Rp<span>8000</span></div>
																</div>
															</div>
															<div class="product_image"><img src="<?php echo base_url('assets/user');?>/images/jus mangga.jpg" alt=""></div>
																...
																<div class="product_buttons">
																	<div class="text-right d-flex flex-row align-items-start justify-content-start">
																		<div class="product_button product_fav text-center d-flex flex-column align-items-center justify-content-center">
																			<div><div><img src="<?php echo base_url('assets/user');?>/images/heart.svg" alt=""><div>+</div></div></div>
																		</div>
																		<div class="product_button product_cart text-center d-flex flex-column align-items-center justify-content-center">
																			<div><div><img src="<?php echo base_url('assets/user');?>/images/cart_2.svg" alt=""><div>+</div></div></div>
																		</div>
																	</div>
																</div>-->
															</div>
													...
													<div class="col-sm-3">
														<div class="home_item_side"><a href="product.html"><img src="<?php echo base_url('assets/user');?>/images/mie_goreng_seafood.jpg" alt=""></a></div>
													</div>
												</div>
											</div>
										</div>
					...
					<!-- Slide 
					<div class="owl-item">
						<div class="background_image" style="background-image:url(<?php echo base_url('assets/user');?>/images/home.jpg)"></div>
						<div class="container fill_height">
							<div class="row fill_height">
								<div class="col fill_height">
									<div class="home_container d-flex flex-column align-items-center justify-content-start">
